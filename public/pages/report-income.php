...
<header class="header">
    ...
    <script src="../js/header.js"></script>
      ...
      <main class="main">
        <article class="table-income">
    <section class="table-income__filters">
        <form action="" class="dropdown table-income__dropdown">
        ...
        <form action="" class="dropdown table-income__dropdown">
            ...
            <section class="dropdown__container">
                ...
                <div class="dropdown__content">
                    <span class="dropdown__item">Стипендия</span>
                    <span class="dropdown__item">Продажа услуг</span>
                    <span class="dropdown__item">Подработка</span>
                </div>
            </section>
        </form>
    </section>
    ...
    <table class="table-income__table">
        <thead>
            <tr>
                <th>Дата</th>
                <th>Категория</th>
        ...
        <tbody>
            <tr>
                ...
                <td>Стипендия</td>
                <td>808,5</td>
                <td>Обокрал колледж</td>
                <td>
                    <div class="table-income__actions">
                        <a href="#">
